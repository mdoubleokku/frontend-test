<template>
  <v-container class="py-8 px-6 bgColor" fluid>
    <v-row>
      <v-col cols="11">
        <v-text-field
          hide-details
      ...
      <v-col cols="1">
        <v-container fluid class="pa-0 mt-1 mgleft">
          <v-row>
            <v-col sm="4">
              <v-btn icon>
      ...
      <v-col cols="3">
        ...
        >
          <div>
            ...
            <p class="mt-4 fontDetails">
              *Update approximately every 10 minutes
            </p>
            <div class="text-center mt-6 mb-6">
              <v-btn rounded outlined class="text-color"> Withdraw Now </v-btn>
            </div>
          </div>
        </v-card>
      </v-col>
      ...
      <v-col cols="12">
        <v-card>
          <v-row>
            <v-col cols="9">
              <v-row>
                <v-col cols="9" class="ml-3 d-flex"
                  ><h1>Published Files</h1></v-col
                >
                <v-col cols="1">
  ...
  methods: {
    ...
    getClassEarningLists(type) {
      if (type === "Icon") return "apexcharts-legend-marker circle colorBlue";
        ...
        return "apexcharts-legend-marker circle colorPink";
